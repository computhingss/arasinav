...
public class OzelAdapter_Paylasim extends BaseAdapter {
    Context context;
    ArrayList<Film> filmler;
    LayoutInflater layoutInflater;

    public OzelAdapter_Paylasim(Context context, ArrayList<Film> filmler) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.satir_paylasim, parent, false);

        TextView satir_kullanici = convertView.findViewById(R.id.satir_kullanici);
        ...
        satir_kullanici.setText(f.getKullanici_adi());
